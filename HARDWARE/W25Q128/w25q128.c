...
void W25QXX_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_1;		   // PE3功能输出
	...
	W25QXX_CS = 1;
	SPI2_Init();		   			//初始化SPI
	SPI2_SetSpeed(SPI_BaudRatePrescaler_2);		//设置为21M时钟
	W25QXX_TYPE=W25QXX_ReadID();	//读取FLASH 
	printf("W25Q128_id:%x\r\n",W25QXX_TYPE);
	OLED_ShowHexNum(2, 13,W25QXX_TYPE, 2);
}
